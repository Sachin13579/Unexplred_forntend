    ...
    >
      ...
      <MDBContainer className="mt-5 mb-4 text-center text-md-left">
        <MDBRow className="mt-3">
          <MDBCol md="3" lg="4" xl="3" className="mb-4 dark-grey-text">
            <h6 className="font-weight-bold">UnexploredTrip</h6>
            <hr
          ...
          <MDBCol md="4" lg="3" xl="3" className="mb-4 dark-grey-text">
            ...
            />
            <p>
              <i className="fa fa-home mr-3" /> Varanasi, UP 221007, India
            </p>
            <p>
              <i className="fa fa-envelope mr-3" /> info@UnexploredTrip.com
            </p>
            <p>
              <i className="fa fa-phone mr-3" /> + 91 955-955-9577
            </p>
            <p>
              <i className="fa fa-print mr-3" /> + 91 700-732-4200
            </p>
          </MDBCol>
        </MDBRow>
      </MDBContainer>
      <div className="footer-copyright text-center py-3 bg-success">
        <MDBContainer fluid>
          ...
          <a href=""> www.unexploredTrip.com</a>
        </MDBContainer>
      </div>
    </MDBFooter>
  );

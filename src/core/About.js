              ...
              <div className="card m-2 ">
                ...
                <div class="card-body m-0 p-0">
                  <p className="text-justify p-3">
                    Unexplored Trip is an Indian Tourism website created by
                    university Students. It is the design to get place in the
                    top tourism website in India. Unexplored Trip started as a
                    mini project, but intended to become a major project.
                    Unexplored Trip will provide many tourism packages in
                    upcoming years. Unexplored Trip aim to have a website with
              ...
              <div className="card m-2 ">
                ...
                <div class="card-body m-0 p-0 mt-2">
                  <a href="#" className="p-3 font-weight-bold text-warning">
                    <i class="fa fa-clock-o" aria-hidden="true"></i> ---2021---
                  </a>
                  <p className="text-justify p-3">
                    Unexplored Trip website is created by Sachin Singh,credited
                    with developing the predecessor to online website. The
                    motivation behind is Most travel websites charges
                    international charges for certain booking when opting
                    internationally, but we aim to provide booking free of any
                    international charges across the globe without a single
                    penny. We also aim to have branches in many countries and we
                    shall provide facility of user interest as per their needs.
                    We aim to deal with the best hotels , motels and lauge, so
                    we provide quality services to our costumers.
                    <br />
                    ...
                    <br />
                    In the december 2021, Unexplored Trip website get Deployed
                    to various platform including github pages and heroku <br />
                    <a href="#" className="font-weight-bold text-success">
                      <i class="fa fa-clock-o" aria-hidden="true"></i> --- April
                      2021---
                    </a>
                    <br />
                    In the April 2021, Unexplored Trip website get itself

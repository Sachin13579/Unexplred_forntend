            ...
            <div className="card my-4">
              <div className="card-header text-center bg-success">
                ...
                <p className="text-justify m-3 text-white">
                  Founded in 2021, Unexplored Trip is India’s leading online
              ...
              <div className="card-body">
                <ul className="list-group">
                  ...
                  <li className="list-group-item">Unexplored Trip</li>
                  <li className="list-group-item ">Varanasi, Uttar Pradesh</li>
                  <li className="list-group-item">India, 2007101</li>
                </ul>
              </div>
            </div>
          </div>
